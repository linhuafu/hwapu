...
#undef  IV_UNICODE
#endif
#define IV_UNICODE              1           /* MTTS 强制使用Unicode方式 */

/* 先不考虑64位下移植问题 */
#define IV_SKIP_64PTR           1           /* 64位todo */

/* VS-2005 */
#if defined(_MSC_VER) && _MSC_VER >= 1400
    #pragma warning(disable : 4996)
    #if IV_SKIP_64PTR   
    #pragma warning(disable : 4311)     /* 指针转整型，32位下忽略 */
    #pragma warning(disable : 4312)     /* 整型转指针，32位下忽略 */
    #endif
#endif /* VS-2005 */
...
/* 64位指针整型转换类型. */
#ifdef IV_TYPE_INT64
    #if IV_SKIP_64PTR       /* 64位todo */
    typedef ivInt32     ivIntptr;       
    typedef ivUInt32    ivUintptr;
    #else
    typedef ivInt64     ivIntptr;
    typedef ivUInt64    ivUintptr;
    #endif
#else
    typedef ivInt32     ivIntptr;
    typedef ivUInt32    ivUintptr;
...
#define ivPTR_2_INT(p)      (ivIntptr)(p)
#define ivPTR_2_UINT(p)     (ivUintptr)(p)
